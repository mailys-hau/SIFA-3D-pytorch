...
class UNet(nn.Module):
    ...
    def __init__(self,
                 in_channels=1, out_channels=4, features=[16, 32, 64, 128, 256], dropout_prob=None
                 ):
...
class MdResUNet(nn.Module):
    ...
    """
    def __init__(self,
                 in_channels=1, out_channels=4, features=[16, 32, 64, 128, 256], num_decoders=3, dropout_prob=None
                 ):
...
if __name__ == "__main__":
    ...
    model = MdResUNet(in_channels=1, out_channels=4, features=[32, 64, 128, 256], dropout_prob=0.)
    pred = model(x)
    print(pred.shape)
